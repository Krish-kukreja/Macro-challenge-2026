...
if configure.compile_configurations["CUDA_FOUND"] == "TRUE":
    ...
    try:
        ...
        HAS_PIN_POS_CUDA_SEGMENT = True
    except ImportError:
        pin_pos_cuda_segment = None
        HAS_PIN_POS_CUDA_SEGMENT = False
...
class PinPosSegmentFunction(Function):
    ...
    def forward(ctx, pos, pin_offset_x, pin_offset_y, pin2node_map,
        ...
        if not pos.is_cuda:
            ...
            _pin_pos_op = pin_pos_cuda_segment if HAS_PIN_POS_CUDA_SEGMENT else pin_pos_cuda
            output = _pin_pos_op.forward(ctx.pos, pin_offset_x,
