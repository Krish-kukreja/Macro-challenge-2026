...
try:
    # When loaded as part of the dreamplace_bundle package
    from .check_overlaps import check_overlaps, check_overlaps_torch
except ImportError:
    # When loaded as a flat dir on sys.path
    from check_overlaps import check_overlaps, check_overlaps_torch
